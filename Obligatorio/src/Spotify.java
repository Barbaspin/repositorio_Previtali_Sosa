...
//        int difDias = (int) Duration.between(fechaInicioDate,fechaFinDate).toDays();
    ...
    //constructor
    public Spotify() {
        this.primerFecha = LocalDate.parse("2023-10-18", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        this.ultimaFecha = LocalDate.parse("2024-05-13", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
