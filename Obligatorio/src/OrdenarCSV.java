...
public class OrdenarCSV {
    ...
    public OrdenarCSV(){
        ...
        a tenerlo en un hash de hashes de listas, esto nos permite hacer las consultas
        */
        ...
        for (int i=0;i<csvDatos.size();i++){
            ...
            if (!hashPaises.contains(fila.get(posPais))){
                ...
                Node<String,MyLinkedListImpl<MyLinkedListImpl<String>>> nodoFechaFila= new Node<>(fila.get(posFecha),listaFilas);
